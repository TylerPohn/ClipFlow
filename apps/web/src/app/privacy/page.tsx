...
export default function PrivacyPolicy() {
  return (
    <div className={styles.container}>
      ...
      <h3>1.2 TikTok Account Data</h3>
      <p>When you connect your TikTok account, we collect and store:</p>
      <ul>
        <li>TikTok OAuth access tokens and refresh tokens (used to publish videos on your behalf)</li>
        <li>Your TikTok account identifier</li>
      </ul>
      <p>
        We do not store your TikTok password. Access tokens are used solely to post
        videos to your TikTok account as you direct.
      </p>

      <h3>1.3 Video and Content Data</h3>
      ...
      <h3>1.5 Cookies and Session Data</h3>
      <p>We use minimal cookies strictly necessary for the operation of the Service:</p>
      <ul>
        <li>
          <strong>Session cookies</strong>: Used to maintain your authenticated session
          after login. These are essential for the Service to function and expire when
          you log out or after a period of inactivity.
        </li>
      </ul>
      ...
      <ul>
        <li><strong>Providing the Service</strong>: Processing your videos, generating captions via transcription, converting video formats, and publishing to TikTok on your behalf.</li>
        <li><strong>Account management</strong>: Authenticating your identity, managing your subscription, and enforcing usage limits.</li>
        <li><strong>Communication</strong>: Sending service-related notifications such as subscription confirmations, usage alerts, and important updates about the Service.</li>
        <li><strong>Service improvement</strong>: Analyzing usage patterns in aggregate to improve features, performance, and reliability.</li>
        <li><strong>Security</strong>: Detecting and preventing fraud, abuse, and unauthorized access.</li>
      </ul>
      <p>We do not sell your personal information to third parties. We do not use your content to train machine learning models.</p>

      <h2>3. Third-Party Services</h2>
      <p>To provide our functionality, we share certain data with the following third-party services:</p>
      ...
      <h3>3.2 OpenAI</h3>
      <p>
        Audio extracted from your videos is sent to OpenAI&apos;s Whisper API for
        transcription. Only the audio content is transmitted; no account information or
        other personal data is included.
      </p>

      <h3>3.3 Cloud Storage Provider</h3>
      <p>
        Video files (both original and processed) are stored using cloud object storage.
        Files are stored securely and are not publicly accessible. Access is restricted
        to your account and our service infrastructure.
      </p>

      <h3>3.4 Payment Processor</h3>
      <p>
        If you subscribe to a paid plan, your payment information is handled by our
        third-party payment processor. We do not directly store your credit card number
        or full payment details on our servers.
      </p>
      ...
      <ul>
        ...
        <li><strong>Deletion</strong>: You can delete your account and all associated data at any time. You can also delete individual videos and their associated transcripts and metadata.</li>
        <li><strong>Export</strong>: You can download your processed videos and transcripts at any time through the Service.</li>
        <li><strong>Correction</strong>: You can update your account information through your profile settings.</li>
        <li><strong>Revoke third-party access</strong>: You can disconnect your TikTok account at any time, which will cause us to delete stored TikTok tokens.</li>
      </ul>
      <p>To exercise any of these rights, you can use the relevant features in the Service or contact us at the email address listed below.</p>
      ...
      <ul>
        ...
        <li>Access controls restricting data access to authorized personnel and systems</li>
      ...
      <p>
        If you access the Service from outside the region where our servers are located,
        your data may be transferred across international borders. By using the Service,
        you consent to the transfer of your information to our servers and the
        third-party services described in this policy.
      </p>
      ...
      <p>
        ...
        &ldquo;Last updated&rdquo; date at the top. Your continued use of the Service
